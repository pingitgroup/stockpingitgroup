...
class UploadHandler
{
    ...
    function __construct($path,$options=null) {
    	$this->path = $path;    	
        $this->options = array(
            'script_url' => $this->getServerUrl().'/',
            'upload_dir' => $this->getFullPath() .'/',
            ...
            'image_versions' => array(
                ...
                */
                'thumbnail' => array(
                    'upload_dir' => $this->getFullPath() .'/thumbs/',
	...
	protected function getServerUrl() {
    	return
    		...
    		BASE_URL .'/doctor/profile/add-note-doc-upload';
    }
    
    protected function getFullPath() {
    	$u_p = PUBLIC_PATH . $this->path;
    	if(!is_dir($u_p)){
    		mkdir($u_p, 0755);
    		mkdir($u_p . "/thumbs" , 0755);
    	}
    	return $u_p;
    }
