...
//     	$isFreeTypeElement = new Zend_Form_Element_Checkbox('pricefree_');
//     	//$isFreeTypeElement->setMultiOptions(array(1=>'%',2=>'Fix Value'));
//     	$isFreeTypeElement->options(array('setCheckedValue'=>1,'setUncheckedValue'=>0));
//     	$isFreeTypeElement->setAttribs(array('onChange'=>'getPriceFree()',));
//     	$this->addElement($isFreeTypeElement);
    	...
    	$discountValueElement->setAttribs(array('class'=>'input100px','onblur'=>'doTotal()',));
    	...
    	$dis_valueElement->setAttribs(array('onblur'=>'doTotal()',));
...
//     	$this->addElement($reqDateElement);
    	...
    	$paidElement->setAttribs(array('class'=>'custom[number]','Onblur'=>'doRemain()'));
    ...
    public function SalesOrder($data=null)
    {
    	...
    	$dis_valueElement = new Zend_Form_Element_Text('dis_value');
    	$dis_valueElement->setAttribs(array('placeholder' => 'Discount Value'));
    	$dis_valueElement->setAttribs(array('onChange'=>'doTotal()',));
    	$this->addElement($dis_valueElement);
    	...
    	//$statusElement->setValue("Open");
    	$opt = array(""=>$tr->translate('Please_Select'),1=>$tr->translate("Qoute"),2=>$tr->translate("Open"),3=>$tr->translate("In Progress"),4=>$tr->translate("Paid"),5=>$tr->translate("Cancell"));
...
//     	$this->addElement($sales_agentElement);  
    	...
    	Application_Form_DateTimePicker::addDateField(array('order_date','offer_date','paid_date'));
    		if($data != null) {
    			...
    			$oldStatusElement = new Zend_Form_Element_Text('oldStatus');
    			$this->addElement($oldStatusElement);
